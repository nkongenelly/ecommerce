...
<button type="button" class="btn btn-warning" data-toggle="modal" data-target="#featureModal">
Add Feature
</button>
<!-- Modal -->
            ...
            <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <select name="feature_id">
                            ...
                            @if(count($product->productfeatures->feature))                   
                                @foreach($product->productfeatures->feature as $feature)
